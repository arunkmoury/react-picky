...
const Placeholder = React__namespace.memo(
  ({
    placeholder,
    value,
    numberDisplayed,
...
const Filter = React__namespace.forwardRef(
...
const Option = React__namespace.memo(
  ({
    id,
    item,
    isSelected,
...
class SelectAll extends React__namespace.PureComponent {
  static displayName = 'Picky(SelectAll)';
  checkboxRef = React__namespace.createRef();
...
class Picky extends React__namespace.PureComponent {
  static defaultProps = {
    id: 'picky',
    numberDisplayed: 3,
    options: [],
  ...
  render() {
    ...
    return React__namespace.createElement(
      ...
      React__namespace.createElement(
        ...
        React__namespace.createElement(Placeholder, {
      ...
      React__namespace.createElement(
        ...
        renderSelectAll
          ...
          : React__namespace.createElement(SelectAll, {
